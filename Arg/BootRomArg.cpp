...
void BromBootArg::FillDefaultValue()
{
    ...
    //set da_log_level && da_log_channel default value to info
    flashtool_connect_arg_.m_da_log_level = DA_LOG_LEVEL_INFO;
    flashtool_connect_arg_.m_da_log_channel= DA_LOG_CHANNEL_UART;
}
...
BromWatchDogArg:: BromWatchDogArg(const FlashTool_EnableWDT_Arg &wdt_arg)
{
     ...
     flashtool_enablewdt_arg_.m_dlbit = wdt_arg.m_dlbit;
     flashtool_enablewdt_arg_.m_bNotResetRTCTime = wdt_arg.m_bNotResetRTCTime;
     flashtool_enablewdt_arg_.m_bNotDisconnectUSB = wdt_arg.m_bNotDisconnectUSB;
}
...
void BromWatchDogArg::Dump()
{
     ...
     LOG("m_dlbit(%d).", flashtool_enablewdt_arg_.m_dlbit);
     LOG("m_bNotResetRTCTime(%d).", flashtool_enablewdt_arg_.m_bNotResetRTCTime);
     LOG("m_bNotDisconnectUSB(%d).", flashtool_enablewdt_arg_.m_bNotDisconnectUSB);	 
}
