...
public:
    ...
    void AfterDAConnected(const DA_REPORT_T *p_da_report, bool need_collect_dev_info);
...
private:
    ...
    void collectDeviceInfo(const DA_REPORT_T *p_da_report);
...
public slots:
    ...
    void slot_GetDAReport(const DA_REPORT_T *p_da_report, const std::string& friend_name,
...
private slots:
    ...
    void slot_show_network_connected(bool connected);
};
