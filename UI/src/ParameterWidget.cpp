...
void ParameterWidget::OnScatterChanged(bool showRegion, bool scatter_ver2)
{
    otp_write_dialog_->onScatterChanged(showRegion, scatter_ver2);
    otp_read_dialog_->onScatterChanged(showRegion, scatter_ver2);
}
