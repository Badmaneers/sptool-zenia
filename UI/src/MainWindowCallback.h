...
public:
	...
	static void __stdcall OperationQuestion(int *p_val);
    static void __stdcall QueryDeviceTracking(int *p_out);
    ...
    static int __stdcall DownloadFlashInit(void* usr_arg, const char * image_name);
    ...
    static void MemoryTestRepairCallback(int op_status_code);
...
signals:
	...
	void signal_OperationQuestion(int *p_val);
    void signal_query_device_tracking(int *p_out);
    ...
    void signal_DownloadFlashInit(void* usr_arg, const QString &image_name);
...
public slots:
	...
	void slot_OperationQuestion(int *p_val);
    void slot_query_device_tracking(int *p_out);
    ...
    void slot_DownloadFlashInit(void* usr_arg, const QString &image_name);
