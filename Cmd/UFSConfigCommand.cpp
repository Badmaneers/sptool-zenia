...
UFSConfigCommand::UFSConfigCommand(APKey key):
    ...
    m_lu3_size_mb(0),
    m_lu3_type(0),
    m_hpb_pinned_start_idx(0),
    m_hpb_pinned_regions(0)
{}
...
void UFSConfigCommand::exec(const QSharedPointer<Connection> &conn)
{
    ...
    cfg.hpb_pinned_start_idx = m_hpb_pinned_start_idx;
    cfg.hpb_pinned_regions = m_hpb_pinned_regions;
    ...
    LOG("hpb_pinned_start_idx: 0x%x", cfg.hpb_pinned_start_idx);
    LOG("hpb_pinned_regions: 0x%x", cfg.hpb_pinned_regions);
