...
LIBEXPORT int __stdcall DA_SLA_Challenge(void *usr_arg, const unsigned char  *p_challenge_in, unsigned int  challenge_in_len, unsigned char  **pp_challenge_out, unsigned int  *p_challenge_out_len);
LIBEXPORT int __stdcall DA_SLA_Challenge_END(void *usr_arg, unsigned char  *p_challenge_out);
...
LIBEXPORT int __stdcall SLA_Feature_Config(void);
