...
typedef struct RomMemChecksumArg{
    unsigned short index;
    unsigned int chksum;
    ...
    // Stop flag
    int *p_stopflag;
    RomMemChecksumArg(): index(0), chksum(0), m_cb_rom_mem_checksum_init(NULL),
        m_cb_rom_mem_checksum_init_arg(NULL), m_cb_rom_mem_checksum(NULL),
        m_cb_rom_mem_checksum_arg(NULL), p_stopflag(NULL)
    {
